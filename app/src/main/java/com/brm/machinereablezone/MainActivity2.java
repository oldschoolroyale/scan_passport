...
public class MainActivity2 extends AbstractNfcActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.MainLayout).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                MainActivity2.this.findViewById(R.id.PassportNbr).clearFocus();
                MainActivity2.this.findViewById(R.id.DateOfBirth).clearFocus();
                MainActivity2.this.findViewById(R.id.DateOfExpiration).clearFocus();
            }
        });
        ((EditText) findViewById(R.id.DateOfBirth)).setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean z) {
                if (z) {
                    MainActivity2.this.selectedDateField = 1;
                    ((InputMethodManager) MainActivity2.this.getSystemService("input_method")).hideSoftInputFromWindow(view.getWindowToken(), 0);
                    MainActivity2.this.displayDatePickerDialog();
                }
            }
        });
        ((EditText) findViewById(R.id.DateOfExpiration)).setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean z) {
                if (z) {
                    MainActivity2.this.selectedDateField = 2;
                    ((InputMethodManager) MainActivity2.this.getSystemService("input_method")).hideSoftInputFromWindow(view.getWindowToken(), 0);
                    MainActivity2.this.displayDatePickerDialog();
                }
            }
        ...
        findViewById(R.id.ReadNfcBtn).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                try {
                    MainActivity2.this.passportNumber = ((EditText) MainActivity2.this.findViewById(R.id.PassportNbr)).getText().toString();
                    PassportStore passportStore = new PassportStore(MainActivity2.this.getApplicationContext());
                    passportStore.setDateOfBirth(MainActivity2.this.dateOfBirth);
                    passportStore.setDateOfExpiry(MainActivity2.this.dateOfExpiration);
                    passportStore.setPassportNumber(MainActivity2.this.passportNumber);
                    passportStore.persist();
                    Intent intent = new Intent(MainActivity2.this, WaitingForNfcActivity.class);
                    intent.putExtra("passportNumber", ((EditText) MainActivity2.this.findViewById(R.id.PassportNbr)).getText().toString());
                    intent.putExtra("dateOfBirth", MainActivity2.this.dateOfBirth);
                    intent.putExtra("dateOfExpiration", MainActivity2.this.dateOfExpiration);
