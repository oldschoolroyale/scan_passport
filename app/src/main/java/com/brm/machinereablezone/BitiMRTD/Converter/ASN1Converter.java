package com.brm.machinereablezone.BitiMRTD.Converter;

import android.util.Log;
import org.json.JSONObject;

public class ASN1Converter {
    private static ASN1Converter asn1Converter;
    JSONObject asn1List;
    ...
    public String translateAsn1Oid(String str) {
        JSONObject jSONObject = this.asn1List;
        if (jSONObject == null) {
            return "unkown";
        }
        try {
